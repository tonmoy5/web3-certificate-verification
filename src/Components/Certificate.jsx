    ...
    <div className="mt-10 p-5 bg-[#ffffff7a] rounded-xl md:w-[60vw] w-[90vw]">
      {
        !certificate.candidate_name == "" ? (
          <>
            ...
            <p className="mt-5 md:text-2xl text-xl p-5 text-justify leading-loose">This is certify that <span className="font-bold underline">{certificate.candidate_name}</span> son/daughter of <span className="font-bold underline">{certificate.fathers_name}</span>  graduated from <span className="font-bold underline">{certificate.academi}</span> Degree in <span className="font-bold underline">{certificate.course_name}</span> in <span className="font-bold underline">{certificate.passing_year}</span> with the CGPA of <span className="font-bold underline">{certificate.gred}</span></p>
